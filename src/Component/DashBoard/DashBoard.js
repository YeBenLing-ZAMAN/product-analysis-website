        ...
        <div className='px-20 pt-5'>
            <div className='grid grid-cols-1 md:grid-cols-2 gap-20 h-[90vh]'>
                <div className='flex justify-center items-center'>
                    <div>
                    <p className='text-center text-xl font-bold text-orange-500'>Investment</p>

                    <LineChart width={630} height={250} data={datas} margin={{ top: 5, right: 20, bottom: 5, left: 0 }}>
                ...
                <div className='flex justify-center items-center'>
                    <div>
                        <p className='text-center text-xl font-bold text-orange-500'>Revenue VS Investment</p>
                        <AreaChart width={630} height={250} data={datas}
                ...
                <div className='flex justify-center items-center'>
                    <div>
                        <h2 className='text-center text-xl font-bold text-orange-500'>Investment VS Revenue VS Sell</h2>
                        <ComposedChart width={630} height={350} data={datas}>
                            <XAxis dataKey="month" />
                            <YAxis />
                            <Tooltip />
                            <Legend />
                ...
                <div className='flex justify-center items-center'>
                    <div>
                        <h2 className='text-center text-xl font-bold text-orange-500'>Investment VS Sell</h2>
